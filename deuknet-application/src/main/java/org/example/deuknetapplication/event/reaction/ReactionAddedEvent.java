...
/**
 * Reaction 추가 이벤트 (Event Sourcing)
 *
 * Reaction이 추가되었다는 사실(fact)을 기록합니다.
 ...
 */
@Getter
public class ReactionAddedEvent extends Projection {
    ...
    @Builder
    public ReactionAddedEvent(UUID reactionId, UUID targetId, ReactionType reactionType,
